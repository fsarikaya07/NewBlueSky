            ...
            <div className={data.classcategory}>
                ...
                <div className="box-content">
                  {this.state.boxcontent.map((data) => (
                    <div key={data.id}>
                      ...
                      <img src="images/bank/bank1.jpg" alt="img" />
                ...
                <div className="flexslider s1">
                  <div className="flat-slides">
                    <ul className="slides">
                      ...
                      <li>
                        <img src="images/bank/bank2.jpg" alt="img" />
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="box-content">
                {this.state.titleplan.map((data) => (
                  <div key={data.id} className="title">
                    {data.title}
                  </div>
                ))}
